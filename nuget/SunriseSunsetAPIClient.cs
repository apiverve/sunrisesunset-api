...
namespace APIVerve.API.SunriseSunset
{
    ...
    /// <summary>
    /// Client for the SunriseSunset API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sunrisesunset";
        ...
        public SunriseSunsetAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SunriseSunsetAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SunriseSunsetAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SunriseSunsetQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SunriseSunsetQueryOptions options)
        {
        ...
        public ResponseObj Execute(SunriseSunsetQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SunriseSunsetQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SunriseSunsetQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SunriseSunsetQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SunriseSunsetQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SunriseSunsetQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SunriseSunsetQueryOptions options)
        {
